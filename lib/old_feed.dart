...
class OldFeed extends StatefulWidget {
  @override
  OldFeedState createState() => new OldFeedState();
}

class OldFeedState extends State<OldFeed> {
    ...
    if (currentUser.userId == activities[index].author.userId) {
      actions.add(ActionSheetAction(
          ...
          onPressed: () {
            ...
            PostActivityState.isComment = OldFeedState.isComment;
                ...
                child: Card(
                  ...
                  child: Column(
                    children: [
                      ...
                      SizedBox(
                        child: Image.network(activity.attachments[0].imageUrl,
                            fit: BoxFit.fill, width: 400, height: 400),
                      ),
                      SizedBox(
                        height: 16,
                      ),
